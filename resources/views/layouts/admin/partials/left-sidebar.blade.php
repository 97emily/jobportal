<nav id="left-sidebar" class="left-sidebar" style="background-color: #00AAD0">
        ...
        <div class="sidebar-body" id="left-sidebar-body">
            <div class="nav-filter align-items-center justify-content-center flex-row mb-4 p-2">
                <div class="input-group">
                    <input type="text" id="quick-search-input" placeholder="Quick search" class="w-100 form-control"
                        tabindex="0" />
                </div>
            </div>
            <!-- end nav-profile -->
