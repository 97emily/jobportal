<x-admin.app-layout>
    <h1 class="header-title h3 mb-4">
        <span class="text-highlight">
            {{ env('APP_NAME') }}</span> <span class="fw-400">{{ __('Dashboard') }}</span>
    </h1>
        ...
        <div class="col-md-6 col-xl-3">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-6">
                            <p class="text-muted text-truncate mb-1">Total Job Listings
                            </p>
                        </div>
                        <div class="col-6">
                    ...
                    <h2 class="fw-300 my-1">{{App\Models\JobListing::count()}}</h2>
                    <div class="mt-3">
        ...
        <div class="col-md-6 col-xl-3">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-6">
                            <p class="text-muted text-truncate mb-1">Assessment Tests</p>
                        </div>
                        <div class="col-6">
                            <div class="icon-sm bg-warning float-end rounded">
                                <i class="fa-solid fa-tags"></i>
                    ...
                    <h2 class="fw-300 my-1">{{App\Models\Assessment::count()}}</h2>
                    <div class="mt-3">
                        <h6>Target <span class="float-end">76%</span></h6>
                        <div class="progress progress-sm m-0">
                            <div class="progress-bar bg-warning" role="progressbar" aria-valuenow="76" aria-valuemin="0"
        ...
        <div class="col-md-6 col-xl-3">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-6">
                            <p class="text-muted text-truncate mb-1">Salary Range</p>
                        </div>
                        <div class="col-6">
                            <div class="icon-sm bg-info float-end rounded">
                                <i class="fa-solid fa-layer-group"></i>
                    ...
                    <h2 class="fw-300 my-1"><span>{{App\Models\SalaryRange::count()}}</span></h2>
                    <div class="mt-3">
                        <h6>Target <span class="float-end">74%</span></h6>
                        <div class="progress progress-sm m-0">
                            <div class="progress-bar bg-info" role="progressbar" aria-valuenow="74" aria-valuemin="0"
        ...
        <div class="col-md-6 col-xl-3">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-6">
                            <p class="text-muted text-truncate mb-1">Job Locations
                            </p>
                        </div>
                        <div class="col-6">
                            <div class="icon-sm bg-primary float-end rounded">
                    ...
                    <h2 class="fw-300 my-1">{{App\Models\Location::count()}}</h2>
                    <div class="mt-3">
                        <h6>Target <span class="float-end">59%</span></h6>
                        <div class="progress progress-sm m-0">
                            <div class="progress-bar bg-primary" role="progressbar" aria-valuenow="59" aria-valuemin="0"
            ...
            <div class="card">
                <div class="card-body">
                    <div class="table-responsive">
                        @include('admin/jobs/table', ['jobs' => \App\Models\JobListing::latest()->take(10)->get()])
                    </div>
                </div>
            </div>
        </div>
