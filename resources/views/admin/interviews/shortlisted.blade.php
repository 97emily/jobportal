                                ...
                                <tbody>
                                    @foreach ($interviews as $key => $interview)
                                        <tr class="item">
                                            ...
                                            <td>
                                                <span
                                                    class="badge {{ empty($interview->interview_score) ? 'bg-warning' : 'bg-info' }}">
                                                ...
                                                <ul class="list-unstyled table-actions">
                                                    <li>
                                                        <a href="javascript:void(0)" class="edit-button"
                                                            ...
                                                            data-applicant-name="{{ $interview->applicant_name }}"
                                                            data-applicant-assessment-score="{{ $interview->assessment_score }}"
                                                            data-applicant-practical-score="{{ $interview->practical_score }}"
                                                            data-applicant-interview-score="{{ $interview->interview_score }}"
                                                            data-applicant-status="{{ $interview->status }}">
                                                            <i class="fa fa-edit" style="color: #000000"
                                                                data-bs-toggle="tooltip"
                                                                title="Update Interview Score"></i>
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <button type="button" class="shortlist-button"
                                                            ...
                                                            <i class="fa {{ $interview->shortlisted == 'shortlisted' ? 'fa-user-check' : 'fa-user-plus' }}"
                                                                style="color: {{ $interview->shortlisted == 'shortlisted' ? '#17a2b8' : '#28a745' }}"
                                                                data-bs-toggle="tooltip"
                                                                title="{{ $interview->shortlisted == 'shortlisted' ? 'Shortlisted' : 'Shortlist?' }}"></i>
                                                        </button>
                                                    </li>
                                                    <li>
                                                        <form
                                                            action="{{ route('interviews.destroy', $interview->id) }}"
                                    ...
                                    <div class="modal-content">
                                        <form id="updateForm" method="POST">
                                            ...
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="editModalLabel">Update Applicant Details
                                                </h5>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" id="interview_score"
                                                        name="interview_score" required>
                                                </div>
                                                <div class="form-group">
