                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            {{-- <div>
                                ...
                                <p class="badge bg-info">All Applicants: {{ count($notShortlistedApplicants) }}</p>
                                <p class="badge bg-success">Shortlisted Applicants:
                                    {{ count(array_filter($notShortlistedApplicants, fn($applicant) => $applicant['applicant']['state'] === 'Shortlisted')) }}
                                </p>
                            </div> --}}
                            <div>
                    ...
                    {{-- <div class="row">
                        ...
                        <div class="col-12">
                            ...
                            {{-- <div class="btn-group" role="group">
                                <form id="practical-test-form" action="{{ route('jobs.sendPracticalTest', $job->id) }}" method="POST" class="d-inline">
                                    @csrf
                                    ...
                                    <button type="button" id="send-practical-test" class="btn btn-primary" style="background-color: #00AAD0"
                                        {{ $job->status == 'Open' ? 'disabled' : '' }}>Send Practical Test</button>
                                </form>
                                <form id="preview-practical-test-form" action="{{ route('practical-test.preview', $practicalTest->id) }}" method="GET" target="_blank" class="d-inline">
                                    @csrf
                                    <input type="hidden" name="practical_tests_id" id="preview_practical_tests_id">
                                    <button type="button" id="preview-practical-test" class="btn btn-secondary">Preview Practical Test</button>
                                </form>
                            </div> --}}
                            {{-- <div class="btn-group" role="group">
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="table-responsive">
                            <table id="job-datatable" class="table-middle table-hover table-responsive table">
                                ...
                                <tbody>
                                    @foreach ($notShortlistedApplicants as $key => $applicant)
                                        <tr>
                                            <td>{{ ++$key }}</td>
                                            ...
                                            {{-- <td><span
                                                    class="badge bg-success">{{ $applicant['applicant']['state'] }}</span>
                                            </td> --}}
