...
<body>
    <div
        ...
        <section style="max-width: 42rem; background-color: #fff;">
            <div
                style="height: 200px; background-color: #00AAD0; width: 100%; color: #000; display: flex; align-items: center; justify-content: center; flex-direction: column; gap: 1.25rem;">
                <div style="display: flex; align-items: center; gap: 0.75rem;">
                    <div style="width: 2.5rem; height: 1px; background-color: #000;"></div>
            ...
            <footer style="margin-top: 2rem;">
                <div
                    ...
                    <div style="text-align: center; display: flex; flex-direction: column; gap: 0.75rem;">
                        <h1 style="color: #000; font-weight: bold;  font-size: 20px; letter-spacing : 2px;">
                            Get in touch
                        </h1>
                        <a href="{{ env('MAIL_FROM_ADDRESS') }}" style="color: #4b5563;" alt="+91-848-883-8308">
                            {{ env('MAIL_FROM_ADDRESS') }}
                        </a>
                        <a href="{{ env('SUPPORT_CONTACT') }}" style="color: #4b5563;" alt="sales@infynno.com">
                            {{ env('SUPPORT_CONTACT') }}
                        </a>
                    </div>
                ...
                <div
                    style="background-color: #00AAD0; padding-top :10px; padding-bottom : 10px; color: #000; text-align: center;">
                    <p class="footertext">
                        &copy; {{ now()->year . ' ' . env('APP_NAME') }} | Built by <a href="#">
                            &nbsp; <span style="color: blue;">Eclectics
                                &trade;</span></a>
                    </p>
                </div>
            </footer>
...
<body>
    ...
    <p> Please use the following credentials to login to your account. Thereafter visit your profile and
